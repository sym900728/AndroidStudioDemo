...
import com.sym.view.RubberIndicator;

/**
 * Created by Administrator on 2015/12/11.
 */
public class TestRubberIndicatorActivity extends AppCompatActivity implements RubberIndicator.OnMoveListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_rubber_indicator);
